...
float spd = 91.15;   // pattern speed (ms), big value is slower
...
int p[] = {
  ...
  */
  ...
  // onegai cindelela debut : https://www.youtube.com/watch?v=5IA8lnYV0tw
  0, 0, 0, 0, 1, 0, //0
  30, 0, 1, 0, 0, 0, //1
  30, 0, 0, 1, 0, 0, //2
  60, 0, 0, 2, 0, 0, //3
